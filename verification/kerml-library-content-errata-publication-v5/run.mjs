...
const gates = {
  ...
  authority: [["four-models", "python -X utf8 verification/kerml-library-content-errata-publication-v5/verify-four-models.py"], ["authority-stop", "python -X utf8 verification/kerml-library-content-errata-publication-v5/verify-authority-stop.py"], ["patch-diff", "python -X utf8 verification/kerml-library-content-errata-publication-v5/verify-patch.py"], ["source-assertions", "python -X utf8 verification/kerml-library-content-errata-publication-v5/verify-source-assertions.py"], ["preservation", "python -X utf8 verification/kerml-library-content-errata-publication-v5/preservation.py"]],
  product: [
    ...
    ["headless-demo", `target\\debug\\agentique.exe --workspace .workspaces/verified-kerml-v5-${Date.now()}.db demo`],
  ],
  strict: [
...
const directory = `verification/kerml-library-content-errata-publication-v5/${label}`;
