...
const gates = {
  ...
  product: [
    ...
    ["headless-demo", `target\\debug\\agentique.exe --workspace .workspaces/verified-kerml-v9-${Date.now()}.db demo`],
  ],
  strict: [
...
const directory = `verification/kerml-semantic-closure-v9/${label}`;
