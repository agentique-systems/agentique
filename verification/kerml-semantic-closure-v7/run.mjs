...
const gates = {
  ...
  product: [
    ...
    ["headless-demo", `target\\debug\\agentique.exe --workspace .workspaces/verified-kerml-v7-${Date.now()}.db demo`],
  ],
  strict: [
...
const directory = `verification/kerml-semantic-closure-v7/${label}`;
