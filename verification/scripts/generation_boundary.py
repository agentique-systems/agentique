...
def protected(name):
    return language(name) or name.startswith("agq-modeling-") or name in {
        "agq-kernel", "agq-standard-libraries", "agq-modeling-workspace", "agq-studio",
        "agq-runtime-publications",
    }
        ...
        while pending:
            ...
            for target in edges.get(path[-1], []):
                ...
                if origin == "agq-kernel" and (language(target) or target in {
                        "agq-standard-libraries", "agq-modeling-workspace", "agq-studio", "agq-runtime-publications"}
                ...
                if (language(origin) or origin in {"agq-kernel", "agq-standard-libraries", "agq-modeling-workspace"}) and target in {
                        "agq-modeling-repository", "agq-modeling-service", "agq-modeling-api", "agq-modeling-http", "agq-modeling-sqlite", "agq-modeling-agent", "agq-modeling-view", "agq-studio", "agq-runtime-publications", "rusqlite", "axum"}:
