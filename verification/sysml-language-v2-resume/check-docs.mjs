...
const files = ["README.md", "docs/architecture.md", "docs/semantic-kernel.md", "docs/sysml-v2-runtime-blocker.md", "verification/sysml-language-v2-resume/README.md",
  ...fs.readdirSync("docs/adr").filter((name) => /^000[1-8]-/.test(name)).map((name) => `docs/adr/${name}`)];
let checked = 0;
