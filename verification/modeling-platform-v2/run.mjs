// Run from the repository root. These checks do not establish platform stage gates.
import fs from "node:fs";
import { spawn } from "node:child_process";

const gates = {
  prerequisite: [
    ["inventory", "node verification/modeling-platform-v2/prerequisites.mjs"],
...
if (!Object.hasOwn(gates, gate)) throw new Error("Specify prerequisite or baseline");
const directory = `verification/modeling-platform-v2/${gate}`;
