...
const gates = {
  ...
  final: [
    ...
    ["independent", "python -X utf8 verification/language-core-completion-v1/direct_xmi.py --check"],
    ["preservation", "node verification/language-core-completion-v1/preservation.mjs"],
  ],
};
const gate = process.argv[2];
if (!Object.hasOwn(gates, gate)) throw new Error("Specify focused or final");
const label = process.argv[3] ?? gate;
if (!/^[a-z0-9-]+$/.test(label)) throw new Error("Invalid evidence label");
const directory = `verification/language-core-completion-v1/${label}`;
