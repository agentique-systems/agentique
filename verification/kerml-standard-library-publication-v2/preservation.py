"""Verify prior evidence and authority, allowing only this milestone's scoped edits."""
...
BASE = "ad6203bbac091342ed098a89ee8915595e404e57"
PREFIXES = (
    "standards/normative/", "standards/generated/", "standards/generated-src/",
    "crates/kerml/", "crates/sysml/", "tools/metamodel-gen/",
...
EXACT = {
    ...
    "standards/baseline-lock.json", "docs/language-core-runtime-contract.md",
    "docs/architecture.md", "docs/sysml-semantic-foundation-review.md",
    "standards/sysml-semantic-coverage.json", "package.json", "package-lock.json",
...
def main():
    ...
    print(json.dumps({"base": BASE, "protected_files": len(hashes), "files": hashes}, indent=2))
