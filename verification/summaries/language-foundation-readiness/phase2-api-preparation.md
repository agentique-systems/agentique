...
| Connection / Interface | `current_connection_related_features` accepts ConnectorAsUsage | Add current/effective connection and interface definitions, ends and related features. Reuse KerML connector-end and related-feature queries; add explicit ConnectorStructure closure requirement covering endpoint/result-structure/typing dependencies, instead of blanket ValueContext. ConnectorAsUsage remains the input domain where the formal query requires it. |
