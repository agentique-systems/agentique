...
const base = "a93f3e94630abc64a3ea16ede27abc22b1dd2d58";
...
const prefixes = ["verification/", "standards/normative/", "standards/generated/", "tools/metamodel-gen/", "standards/libraries/", "crates/kernel/", "crates/kerml/", "crates/kerml-semantics/", "crates/kerml-syntax/", "crates/kerml-text/"];
...
const capturePath = "verification/language-core-completion-v2/preservation-inputs.json";
...
if (hash(git(["show", `${base}:standards/generated/sysml-2.0/structural-audit.json`])) !== hash(fs.readFileSync("verification/language-core-completion-v2/original-structural-audit.json"))) throw new Error("Original audit copy differs");
