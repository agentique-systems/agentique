...
## Synthetic camera runs

| Fixture | Passed | Steady p95 ms | Pan p95 ms | Zoom p95 ms |
|---|---|---:|---:|---:|
| stress1000 | True | 6.195 | 6.162 | 6.182 |
| stress10000 | False | 6.319 | 13.273 | 13.130 |
| stress10000 | True | 6.232 | 12.492 | 11.371 |

Environment and launch receipts are retained in JSON; inclusion does not assert a quiet machine or a causal comparison.
