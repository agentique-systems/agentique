...
API = "https://api.github.com/repos/agentique-systems/agentique/actions/artifacts/10899946153"
token = subprocess.check_output(["gh", "auth", "token"], text=True).strip()
headers = {"Authorization": "Bearer " + token, "Accept": "application/vnd.github+json", "X-GitHub-Api-Version": "2022-11-28"}
metadata = json.load(urllib.request.urlopen(urllib.request.Request(API, headers=headers)))
assert metadata["id"] == 10899946153
assert metadata["workflow_run"]["head_sha"] == "4241d7e9e524e5b858aa379e81b20bcb6f2d6a96"
assert metadata["size_in_bytes"] == 187453481
