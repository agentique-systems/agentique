...
#[test]
fn eight_immutable_profiles_keep_their_earliest_correction_boundaries() {
    ...
    .enumerate()
    {
        ...
        assert_eq!(profile.corrects_owned_cross_feature(), index >= 7);
        assert_eq!(
            profile.owned_cross_feature_manifest_sha256().is_some(),
            index >= 7
        );
