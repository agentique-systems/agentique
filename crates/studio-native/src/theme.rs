...
impl Theme {
    pub fn new(dark: bool, contrast: bool) -> Self {
        ...
        if dark {
            Self {
                ...
                contrast,
                canvas: rgb(17, 22, 29),
                surface: rgb(24, 30, 39),
                elevated: rgb(33, 41, 53),
                border: if contrast {
                    rgb(136, 158, 183)
                } else {
                    rgb(51, 63, 80)
                },
                text: rgb(229, 235, 243),
                muted: if contrast {
                    rgb(200, 211, 224)
                } else {
                    rgb(143, 160, 181)
                },
                accent: rgb(121, 184, 225),
                green: rgb(126, 199, 169),
                amber: rgb(221, 184, 122),
                violet: rgb(174, 161, 221),
            }
        } else {
            Self {
                dark,
                contrast,
                canvas: rgb(236, 240, 245),
                ...
                text: rgb(33, 46, 63),
                muted: rgb(84, 103, 124),
                accent: rgb(27, 103, 153),
                green: rgb(38, 116, 89),
                amber: rgb(140, 93, 35),
                violet: rgb(112, 84, 167),
            }
        }
    }
    pub fn install(self, ctx: &egui::Context) {
        ...
        style
            .text_styles
            .insert(egui::TextStyle::Small, FontId::proportional(CAPTION));
        ctx.set_style_of(
            if self.dark {
                egui::Theme::Dark
            } else {
