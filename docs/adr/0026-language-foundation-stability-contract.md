...
| Immutable accepted dependencies | Projects share accepted standard records and identities. Local declarations can reference a dependency but cannot modify its records, ownership or semantic visibility. Its immutable closure boundary discharges requirements no local producer may change; it does not close local relationships or local searches merely because they mention a standard element. |
